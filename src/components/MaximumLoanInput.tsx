...
export const MaximumLoanInput: React.FC<MaximumLoanInputProps> = ({ value, onChange }) => {
  const handleInterestRateChange = (newValue: number | null): void => {
    onChange({ ...value, interestRate: newValue })
  }
  const handleMonthlyPaymentsChange = (newValue: number | null): void => {
    onChange({ ...value, monthlyPayments: newValue })
  }
    ...
    <div className='flex flex-col md:flex-row'>
      <div className='flex flex-col w-full md:w-4/12 md:mr-3 mb-3 md:mb-0 justify-end'>
        <InputField
          ...
          value={value.monthlyPayments}
          onChange={handleMonthlyPaymentsChange}
